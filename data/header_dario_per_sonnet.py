...
header_dario_ps = """<?xml version="1.0" encoding="UTF-8"?><?xml-model href="https://raw.githubusercontent.com/pruizf/disco/master/schema/tei_all_DISCO.rnc" type="application/relax-ng-compact-syntax"?> 
<TEI xmlns="http://www.tei-c.org/ns/1.0">
   <teiHeader>
      <fileDesc>
         <titleStmt about="file_po_{item_id_in_seq}">
            <title property="dc:title">{item_title}</title>
            <author property="dc:creator" resource="disco:{item_id_in_seq}">Rubén Darío</author>
         ...
         <particDesc>
            <listPerson>
               <person xml:id="disco_694n" about="disco:694n" typeOf="foaf:Person">
                  ...
                  <persName type="source" property="foaf:name">Darío, Rubén</persName>
